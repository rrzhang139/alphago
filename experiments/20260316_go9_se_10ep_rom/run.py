#!/usr/bin/env python3
"""Go 9x9 SE+GP with 10 epochs and random opening moves.

Combines the two biggest local findings:
1. 10 epochs per iteration: 47% lower loss than 5 epochs (1.337 vs 2.537 in 5 iters)
2. Random opening moves (6): 5.5% better loss, more diverse training

Plus all proven improvements:
- SE blocks + global pool (best architecture: 1.389 vs 1.639 baseline)
...
def main():
    ...
    config = AlphaZeroConfig(
        ...
        training=TrainingConfig(
            ...
            weight_decay=1e-4,
            batch_size=256,
            epochs_per_iteration=10,  # KEY: 47% better loss than 5 epochs
            ...
            buffer_window=10,
            random_opening_moves=6,  # KEY: 5.5% better loss, more diverse games
    ...
    print(f"SE+GP, 10 epochs, ROM=6, from scratch, 500 iters")
    print(f"All improvements: pruning=0.03, VLW=0.5, BS=256")
